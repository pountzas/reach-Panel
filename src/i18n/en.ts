export const en = {
  ...
  modeTabletsHint:
    "Normal and Mini are typing keyboard. Teaching opens lessons; Music shows the synthesizer. Companion is available only while a tablet is connected.",
  ...
  companionUsbStep1:
    "On the Android tablet: Settings → Network → Hotspot & tethering → enable USB tethering.",

  companionUsbStep2:
    "Connect the tablet to this PC with a data USB cable (not charge-only).",

  companionUsbStep3:
    "Click “New pairing code” so the QR uses the USB network IP (often 192.168.42.x or 192.168.137.x).",

  companionUsbStep4:
    "On the tablet, scan the updated QR (or paste JSON). Same protocol as Wi‑Fi — no special USB driver stack.",

  companionUsbStep5:
    "Already paired? Scanning the new QR updates the IP and reconnects without a full re-pair when the host ID matches.",
