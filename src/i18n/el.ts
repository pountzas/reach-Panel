...
export const el: Record<keyof typeof en, string> = {
  ...
  settingsCompanion: "Συνοδός",
  companionDescription:
    "Συνδέστε ένα tablet Android για να ελέγχετε αυτόν τον υπολογιστή μέσω Wi‑Fi. Το tablet γίνεται η επιφάνεια ελέγχου όσο είναι συνδεδεμένο.",
  companionDownloadsHint:
    "Κατεβάστε το APK του tablet και τους εγκαταστάτες Windows από τον ιστότοπο λήψεων.",
  companionOpenDownloads: "Άνοιγμα ιστότοπου λήψεων",
  companionBridgeRunning: "Η γέφυρα εκτελείται",
  companionBridgeStopped: "Η γέφυρα σταμάτησε",
  companionPort: "Θύρα",
  companionSession: "Συνεδρία",
  companionSessionIdle: "Αδρανής",
  companionSessionActive: "Ενεργή",
  companionSessionReconnecting: "Επανασύνδεση",
  companionConnectedDevice: "Συνδεδεμένη συσκευή",
  companionAudioRouting: "Δρομολόγηση ήχου",
  companionAudioHost: "Υπολογιστής",
  companionAudioTablet: "Tablet",
  companionStart: "Έναρξη γέφυρας",
  companionStop: "Διακοπή γέφυρας",
  companionRefreshQr: "Νέος κωδικός σύζευξης",
  companionQrHint: "Σαρώστε αυτό το QR με το ReachPanel Συνοδός στο tablet σας.",
  companionQrAlt: "QR σύζευξης Συνοδού",
  companionCopyPayload: "Αντιγραφή JSON σύζευξης",
  companionCopied: "Το JSON σύζευξης αντιγράφηκε",
  companionPairedDevices: "Συζευγμένες συσκευές",
  companionNoDevices: "Δεν υπάρχουν ακόμη συζευγμένα tablet.",
  companionRevoke: "Ανάκληση",
  companionRevoked: "Η συσκευή ανακλήθηκε",
  ...
  companionUsbStep2:
    "Συνδέστε το tablet σε αυτόν τον υπολογιστή με καλώδιο USB δεδομένων (όχι μόνο φόρτισης).",
  companionUsbStep3:
    "Κάντε κλικ στο «Νέος κωδικός σύζευξης» ώστε το QR να χρησιμοποιεί την IP του δικτύου USB (συχνά 192.168.42.x ή 192.168.137.x).",
  companionUsbStep4:
    "Στο tablet, σαρώστε το ενημερωμένο QR (ή επικολλήστε JSON). Ίδιο πρωτόκολλο με το Wi‑Fi — χωρίς ειδικό πρόγραμμα οδήγησης USB.",
  companionUsbStep5:
    "Ήδη συζευγμένο; Η σάρωση του νέου QR ενημερώνει την IP και επανασυνδέει χωρίς πλήρη επανασύζευξη όταν ταιριάζει το host ID.",
