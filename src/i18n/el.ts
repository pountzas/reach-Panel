...
export const el: Record<keyof typeof en, string> = {
  ...
  modeTabletsHint:
    "Κανονική και Mini είναι πληκτρολόγιο. Η Διδασκαλία ανοίγει μαθήματα· η Μουσική δείχνει τον συνθετητή. Ο Συνοδός είναι διαθέσιμος μόνο όσο είναι συνδεδεμένο ένα tablet.",
