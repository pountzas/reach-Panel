...
export const fr: Record<keyof typeof en, string> = {
  ...
  resizeWindowHeight: "Redimensionner la hauteur de la fenêtre",
  ...
  groqApiKeyHint:
    "Nécessaire pour les langues non prises en charge par Windows (ex. grec). Vous pouvez aussi définir la variable d’environnement GROQ_API_KEY.",

  groqApiKeyLink: "Obtenir une clé API Groq gratuite",
  ...
  settingsCompanion: "Compagnon",
  companionDescription:
    "Associez une tablette Android pour contrôler ce PC via Wi‑Fi. La tablette devient la surface de contrôle tant qu’elle est connectée.",
  companionDownloadsHint:
    "Téléchargez l’APK tablette et les installateurs Windows depuis le site de téléchargements.",
  companionOpenDownloads: "Ouvrir le site de téléchargements",
  companionBridgeRunning: "Pont en cours d’exécution",
  companionBridgeStopped: "Pont arrêté",
  companionPort: "Port",
  companionSession: "Session",
  companionSessionIdle: "Inactif",
  companionSessionActive: "Actif",
  companionSessionReconnecting: "Reconnexion",
  companionConnectedDevice: "Appareil connecté",
  companionAudioRouting: "Routage audio",
  companionAudioHost: "PC hôte",
  companionAudioTablet: "Tablette",
  companionStart: "Démarrer le pont",
  companionStop: "Arrêter le pont",
  companionRefreshQr: "Nouveau code d’association",
  companionQrHint: "Scannez ce QR avec ReachPanel Compagnon sur votre tablette.",
  companionQrAlt: "QR d’association Compagnon",
  companionCopyPayload: "Copier le JSON d’association",
  companionCopied: "JSON d’association copié",
  companionPairedDevices: "Appareils associés",
  companionNoDevices: "Aucune tablette associée pour l’instant.",
  companionRevoke: "Révoquer",
  companionRevoked: "Appareil révoqué",
  companionDeviceRevokedBadge: "Révoqué",
  companionLastSeen: "Dernière activité",
  companionCandidateIps: "IP locales détectées",
  companionUsbTitle: "Partage USB (sans Wi‑Fi)",
  companionUsbStep1:
    "Sur la tablette Android : Paramètres → Réseau → Point d’accès et partage → activer le partage de connexion USB.",
  companionUsbStep2:
    "Connectez la tablette à ce PC avec un câble USB de données (pas charge seule).",
  companionUsbStep3:
    "Cliquez sur « Nouveau code d’association » pour que le QR utilise l’IP du réseau USB (souvent 192.168.42.x ou 192.168.137.x).",
  companionUsbStep4:
    "Sur la tablette, scannez le QR mis à jour (ou collez le JSON). Même protocole que le Wi‑Fi — pas de pile de pilotes USB spéciale.",
  companionUsbStep5:
    "Déjà associé ? Scanner le nouveau QR met à jour l’IP et reconnecte sans une nouvelle association complète lorsque l’ID hôte correspond.",
