...
export const pt: Record<keyof typeof en, string> = {
  ...
  modeTabletsHint:
    "Normal e Mini são teclado. Ensino abre o sintetizador com lições.",
  ...
  transparentKeyColorWhite: "Branco",

  transparentKeyColorDarkGray: "Cinza escuro",
  ...
  colorProfileLightGrey: "Cinzento claro",

  colorProfileDarkGrey: "Cinzento escuro",
  ...
  synthesizerHint: "Toque nas teclas para tocar notas",
  ...
  shiftPianoHigher: "Deslocar piano para cima",

  octavesShort: "oitavas",

  mouseHiddenForWidePiano: "Rato oculto com 5 oitavas",

  octaveCount2: "2 oitavas",

  octaveCount3: "3 oitavas",

  octaveCount4: "4 oitavas",

  octaveCount5: "5 oitavas",
  ...
  keyTextColor: "Cor do texto das teclas",

  mousePanelColor: "Painel do rato",

  chooseBackgroundImage: "Escolher imagem de fundo",

  removeBackgroundImage: "Remover imagem de fundo",

  backgroundImageOpacity: "Visibilidade da imagem de fundo",

  newProfileFileName: "Nome do novo ficheiro de perfil",
  ...
  quickActionTarget: "Destino (app ou URL)",
