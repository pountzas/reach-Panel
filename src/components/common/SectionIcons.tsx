...
export function SourceCodeIcon({ className = iconClass }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function XMarkIcon({ className = iconClass }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function DownloadTrayIcon({ className = iconClass }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function EnvelopeIcon({ className = iconClass }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
